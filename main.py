...
def load_data():
    data = Dataset(root='ptb_graphs/mettack/', name=args.dataset, setting='prognn')
...
perturbed_data = PrePtbDataset(root='ptb_graphs/mettack/',
                                       name=args.dataset,
...
perturbed_adj = torch.from_numpy(perturbed_adj)
